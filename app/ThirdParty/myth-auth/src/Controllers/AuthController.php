...
class AuthController extends Controller
{
	...
	public function attemptLogin()
	{
		...
		if (($checkVillage == null) && (in_groups('admin') == false)) {
			$this->auth->logout();
			return redirect()->back()->withInput()->with('message', 'You cant log in yet, please wait for the admin to setup the app');
		}
		if (($checkVillage == null) && (in_groups('admin') == true)) {
