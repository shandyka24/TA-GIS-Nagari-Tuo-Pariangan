            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h4 class="card-title">Exclusive Activity</h4>
                                ...
                                <div class="col-md-9">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <a title="Detail Homestay Unit" class="btn icon btn-outline-info btn-sm mb-1 me-1 float-end" data-bs-toggle="modal" data-bs-target="#infoActivity<?= esc($item['id']); ?>">
                                    ...
                                    <div class="row g-0">
                                        ...
                                        <div class="col-md-6">
                                            <div class="card-body">
                                                ...
                                                ?>
                                                <p class="card-text mt-3"><?= esc($activity['description']); ?></p>
                                                <p class="card-text"><small class="text-dark"><?= esc("Rp " . number_format($item['price'], 0, ',', '.')) ?></small></p>
                                            </div>
                                        </div>
                                    </div>
