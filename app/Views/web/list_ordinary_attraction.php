        ...
        <div class="col-md-4 col-12">
            <div class="row">
                ...
                <div class="col-12" id="list-rg-col">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title text-center fs-4 fw-bolder">List <?= ($title=='Unique Attraction')?'Unique':'Ordinary' ?> Attraction</h5>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody id="table-data" style="font-size: 20px;">
                                        <?php if (isset($data)) : ?>
                                            ...
                                            <?php foreach ($data as $item) : ?>
                                                <tr>
                                                    <script>
                                                        objectMarker("<?= esc($item['id']); ?>", <?= esc($item['lat']); ?>, <?= esc($item['lng']); ?>, true, "<?= esc($item['attraction_category']); ?>");
                                                    </script>
                                                    <td><?= esc($i); ?></td>
