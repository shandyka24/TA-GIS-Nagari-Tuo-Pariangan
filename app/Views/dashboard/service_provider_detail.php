            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                            <a href="<?= base_url('dashboard/serviceProvider/edit'); ?>/<?= esc($data['id']); ?>" class="btn btn-primary float-end"><i class="fa-solid fa-pencil me-3"></i>Edit</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row">
                        ...
                        <div>
                            <div class="col table-responsive">
                                        ...
                                        <?php else : ?>
                                            ...
                                            <?php foreach ($services as $service) : ?>
                                                <tr style="font-size: 15px;">
                                                    ...
                                                    <td>Rp.<?= esc($service['price']); ?>/<?= esc($service['unit_price']); ?></td>
                                                    <td style="width: 100px;">
                                                        <a title="Edit" class="btn icon btn-outline-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editService<?= esc($service['id']); ?>">
                                                            <i class="fa-solid fa-edit"></i>
                                                        </a>
                                                        <a data-bs-toggle="tooltip" data-bs-placement="bottom" title="Delete" class="btn icon btn-outline-danger btn-sm" onclick="deleteObject('J<?= esc($service['id']); ?>', '<?= esc($service['name']); ?>', 'false')">
                                ...
                                <div class="col-auto">
                                    <center>
                                        <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#insertService"><i class="fa-solid fa-add me-3"></i>Add Service</a>
                                    </center>
                                </div>
                                <!-- Modal Add Service -->
