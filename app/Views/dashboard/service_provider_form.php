    ...
    <div class="row">
        ...
        <div class="col-md-6 col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form form-vertical" action="<?= ($edit) ? base_url('dashboard/serviceProvider/update') . '/' . $data['id'] : base_url('dashboard/serviceProvider'); ?>" method="post" onsubmit="checkRequired(event)" enctype="multipart/form-data">
                        <div class="form-body">
                            ...
                            <div class="form-group mb-4">
                                <label for="name" class="mb-2">Service Provider Name</label>
                                <input type="text" id="name" class="form-control" name="name" placeholder="Service Provider Name" value="<?= ($edit) ? $data['name'] : old('name'); ?>" required>
                            </div>
                            <div class="form-group mb-4">
