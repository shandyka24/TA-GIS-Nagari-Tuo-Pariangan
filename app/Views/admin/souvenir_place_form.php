                    ...
                    <form class="form form-vertical" action="<?= ($edit) ? base_url('dashboard/souvenirPlace/update') . '/' . $data['id'] : base_url('dashboard/souvenirPlace'); ?>" method="post" onsubmit="checkRequired(event)" enctype="multipart/form-data">
                        <div class="form-body">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" id="name" class="form-control" name="name" placeholder="Souvenir Place Name" value="<?= ($edit) ? $data['name'] : old('name'); ?>" required>
                            </div>
                            <div class="form-group mb-4">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" maxlength="25" id="employee_name" class="form-control" name="employee_name" placeholder="Employee Name" value="<?= ($edit) ? $data['employee_name'] : old('employee_name'); ?>" required>
                            </div>
                            <div class="form-group mb-4">
                                <label for="phone" class="mb-2">Phone</label>
                                <input type="text" maxlength="13" id="phone" class="form-control" name="phone" placeholder="Phone" value="<?= ($edit) ? $data['phone'] : old('phone'); ?>" required>
                            </div>
                            <div class="form-group mb-4">
