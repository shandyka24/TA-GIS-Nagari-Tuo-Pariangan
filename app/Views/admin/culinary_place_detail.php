            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h4 class="card-title text-center fs-4 fw-bolder">Culinary Place Information</h4>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col table-responsive">
                                                            ...
                                                            <a data-bs-toggle="modal" data-bs-target="#infoProduct<?= esc($product['culinary_product_id']); ?>">
                                                                <div class="card" style="border: 1px solid #969696;">
                                                                    ...
                                                                    <div class=" card-body">
                                                                        ...
                                                                        <p class="card-text mb-3">Rp. <?= esc($product['price']); ?></p>
                                                                        <a data-bs-toggle="tooltip" data-bs-placement="bottom" title="Delete" class="btn icon btn-outline-danger btn-sm float-end ms-1" onclick="deleteObject('U<?= esc($product['culinary_place_id']); ?><?= esc($product['culinary_product_id']); ?>', '<?= esc($product['name']); ?>', 'false')">
                                                                            <i class="fa-solid fa-trash"></i>
                                                                        </a>
                                                                        <a title="Edit" class="btn icon btn-outline-warning btn-sm float-end ms-1" data-bs-toggle="modal" data-bs-target="#editProduct<?= esc($product['culinary_product_id']); ?>">
                                        ...
                                        <div class="modal-body">
                                            <div class="card-body">
                                                <form class="form form-vertical" action="<?= current_url(); ?>/product" method="post" onsubmit="checkRequired()" enctype="multipart/form-data">
                                                    <div class="form-body">
                                                        <input type="hidden" name="culinary_place_id" value="<?= esc($data['id']); ?>">
                                                        <fieldset class="form-group mb-4">
                                                            <script>
                                                                getListCPP('', '<?= esc($data['id']); ?>');
                                                            </script>
                                                            <label for="catSelect" class="mb-2">Product</label>
                                                            <select class="form-select" id="proSelect" name="culinary_product_id" required>
                                                            </select>
                                                        </fieldset>
                            ...
                            <?php if (!empty($products)) : ?>
                                <?php foreach ($products as $product) : ?>
                                    <div class="modal fade" id="editProduct<?= esc($product['culinary_product_id']); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    <div class="card-body">
                                                        <form class="form form-vertical" action="<?= current_url(); ?>/product/<?= esc($product['culinary_product_id']); ?>" method="post" enctype="multipart/form-data">
                                                            <div class="form-body">
                                                                <input type="hidden" name="culinary_place_id" value="<?= esc($data['id']); ?>">
                                                                <fieldset class="form-group mb-4">
                                                                    <label for="catSelect" class="mb-2">Product</label>
                                                                    <select class="form-select" id="proSelect" name="culinary_product_id" disabled>
                                                                ...
                                                                <div class="form-group mb-4">
                                                                    <label for="gallery" class="form-label">Gallery</label>
                                                                    <input class="form-control" accept="image/*" type="file" name="gallery[]" id="gallery<?= esc($product['culinary_product_id']); ?>" required>
                                                                </div>
                                                                <div class="form-group mb-4">
                                                                    <label for="description" class="form-label">Description</label>
