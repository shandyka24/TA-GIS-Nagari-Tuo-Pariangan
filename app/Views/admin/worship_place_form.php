                    ...
                    <form class="form form-vertical" action="<?= ($edit) ? base_url('dashboard/worshipPlace/update') . '/' . $data['id'] : base_url('dashboard/worshipPlace'); ?>" method="post" onsubmit="checkRequired(event)" enctype="multipart/form-data">
                        <div class="form-body">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" id="name" class="form-control" name="name" placeholder="Worship Place Name" value="<?= ($edit) ? $data['name'] : old('name'); ?>" required>
                                </select>
                            </div>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    <input type="number" id="capacity" class="form-control" name="capacity" placeholder="Capacity" aria-label="Ticket Price" aria-describedby="ticket-price" value="<?= ($edit) ? $data['capacity'] : old('capacity'); ?>">
...
<script>
    ...
    function checkRequired(event) {
        if (!$('#geo-json').val()) {
            ...
            Swal.fire('Please select location for the New Worship Place');
        }
    }
</script>
<script>
