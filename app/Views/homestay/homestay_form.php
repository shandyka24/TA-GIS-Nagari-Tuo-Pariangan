            ...
            <div class="card">
                ...
                <div class="card-body">
                    <?php if (in_groups('owner')) : ?>
                        ...
                        <?php else : ?>
                            <form class="form form-vertical" action="<?= ($edit) ? base_url('dashboard/homestay/manage/update') . '/' . $data['id'] : base_url('dashboard/homestay/manage'); ?>" method="post" onsubmit="checkRequired(event)" enctype="multipart/form-data">
                            <?php endif; ?>
                            <div class="form-body">
